export default {
  ...
  home: {
    ...
    gradeSubjects: {
      title: 'የ{{grade}}ኛ ክፍል የትምህርት አይነቶች',
    ...
    quickActions: {
      ...
      nationalExams: {
        title: 'የብሔራዊ ፈተናዎች (አ.አ)',
        subtitle: 'በቀድሞ ፈተናዎች ይለማመዱ',
        yearExam: 'የ{{year}} ብሔራዊ ፈተና (አ.አ)',
        grade: '{{grade}}ተኛ ክፍል'
      }
    },
    reportCards: {
  ...
  mcq: {
    ...
    nationalExam: 'የብሔራዊ ፈተና ጥያቄዎች (አ.አ)',
    mcqExam: 'የMegaTest የምርጫ ጥያቄዎች',
    nationalExamDescription: 'ያለፉትን ዓመታት የብሔራዊ ፈተና ጥያቄዎችን ይሞክሩ (አ.አ)',
    ...
    pictureQuiz: {
      ...
      dragInstruction: 'ትክክለኛውን መልስ ይምረጡ',
      instructions: {
        look: {
          title: 'ምስሉን ተመልከት',
    ...
    results: {
      ...
      tryOtherNationalExam: 'ሌሎች ቀሪ የብሔራዊ ፈተናዎችን ይሞክሩ (አ.አ)',
    ...
    subjects: {
      ...
      openNationalExam: 'የብሔራዊ ፈተና ወረቀቶች (አ.አ)',
  ...
  profile: {
    ...
    resetAppError: 'የመተግበሪያውን መረጃ ማመለስ አልተቻለም። እባክዎ እንደገና ይሞክሩ።',
    resetPasswordPrompt: 'የመተግበሪያውን መረጃ ለመመለስ እባክዎ የይለፍ ቃልዎን ያስገቡ። ይህ ሁሉንም የእድገትዎ እና የሪፖርቶችዎን ያጸዳል፣ ግን አሁንም ገብተው ይገኛሉ።',
