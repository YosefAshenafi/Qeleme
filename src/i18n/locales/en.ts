export default {
  ...
  home: {
    ...
    quickActions: {
      ...
      nationalExams: {
        title: 'National Exams (A.A)',
        subtitle: 'Practice with past papers',
        yearExam: '{{year}} National Exam (A.A)',
        grade: 'Grade {{grade}}'
      }
    },
    reportCards: {
  ...
  mcq: {
    ...
    mcqExam: 'MegaTest\'s MCQ Quizzes',
    nationalExamDescription: 'Try previous years\' national exam questions (A.A)',
    ...
    pictureQuiz: {
      ...
      dragInstruction: 'Choose the correct answer',
      instructions: {
        look: {
    ...
    results: {
      ...
      tryOtherNationalExam: 'Try Other Remaining National Exams (A.A)',
    ...
    subjects: {
      ...
      openNationalExam: 'Past national exam papers (A.A)',
