export const LANDING_DATA = {
  ...
  hero: {
    badge: "The Vanguard of Higher Education",
    backgroundImage: "https://lh3.googleusercontent.com/aida-public/AB6AXuB3APx85k4Fv2Bgy8AeOlmQPjaaev8ow2eP3evfaU42oJBlvAfz2d11D4O-hlbvh1jcLpQVWM4FLXR4V8l83DnRsdeXF4qZgRWK_bahFMiicnURFAVYPN9Wmlmn7UKAH9rbA-H9J-J0h0hwRxky-A2vMtvsF-uPJ-lZFUJLFm7GyWUgfPfOuBsCuLiRPB6Jwr_LdeC3ibnwaqKMUereFcZJkM0H51H9FAPP4GzBCC-hHYVOkOGFoPSzNaau8FLGVwRyHhvIhivptJfi",
    description: "Where tradition meets the future of cognition. Mega Test provides the definitive assessment framework for the world's most ambitious academic minds."
  },
  stats: [
    { value: "99.9%", label: "Accuracy" },
    { value: "140+", label: "Institutions" },
    { value: "25M", label: "Tests Taken" },
    { value: "Top 5", label: "Global Ranking" }
  ],
  features: {
    images: {
      dataViz: "https://lh3.googleusercontent.com/aida-public/AB6AXuCSZrcXMQsw5GUcU--Xttmw0Ke1Sgt-REWPeMLHGs9lpAJIO5f_Sgry1vFRajF66zMCduuSJE97aqw2F_5rC7NJOc7DcEshmK8BCHJ9pcRfTeK_Bo6Z6Rb21HHgnK1oreM-raDNGf3-cM8xvwFkPkH-GjZJaWoupLxrZvoEGh5Qj2vMwFd2FtIB2z3GpUUfJfO8JYgMSrWciLgIQOVNmrE51NDIj9s8uhk7q7rwhdJM5AYulzH42gjXy9PxM5e009EfB0IXwHr-y_DB",
      collaboration: "https://lh3.googleusercontent.com/aida-public/AB6AXuCyXHlHS53TEb5sW8xmpJVJbLRc9P9ZXzWKZ19lWfETL95DHHG_JX4rzYGdnqDum03su7hlFQpQO0Oavo_OFAfrgN5GcKJhqCQlMwjSZXrCGIPsIKQF5CF3Vwe8HaiIxVfQUrN5Hf2lrwVOZzG4x96Vh39M96dC4jMHR8eEzw-U-gx-_U1zNISGA-yLbF58lffhRfdp2yHh7W4IK5T0FKFzTkdCxN_CcSDOvZ0Pt957tD6MJ6MpkTdKzgRoB8D14NaHqAu_kPEEi05E"
    }
  },
  pricing: [
    {
      ...
      features: ["5 Monthly Assessments", "Basic Analytics", "Digital Credential"],
      featured: false
    },
    {
      tier: "Academic",
      ...
      features: ["Unlimited Assessments", "Advanced AI Insights", "Institutional Benchmarking", "Priority Support"],
      featured: true
    },
    {
      tier: "Institution",
      ...
      features: ["White-Label API", "Dedicated Success Lead", "Custom Data Governance", "On-Premise Support"],
      featured: false
    }
  ],
  cta: {
    backgroundImage: "https://lh3.googleusercontent.com/aida-public/AB6AXuDfCxOKFQaFkIFuxMioOt9LnBmWSixA56gsU9lf-ofImJfonc0QnrKLlm9QbpD8REokOD1zW8ACnXBuh2bH1qmMKOT4-iQkg-BdlvSRKGzfpwbHW6NOU0EMzG_iZFOyybR7-FXT43Uid-znRBdY6AZefSj96pezjtCXT9pcZu1CjPpggp0bUspD4UfG_1bQqxLefxSmQEtosCC7uXrQNczieE1p2Eh8DxXNtRYkDKAtzGgo7O2OAFyU9hNdcBzCm7PUU_a7Ee2wPb9_"
  },
  footer: {
    links: [
    ...
    copyright: "© 2024 Mega Test Academic Vanguard. All rights reserved."
  }
};

export const AUTH_DATA = {
  login: {
    heroImage: "https://lh3.googleusercontent.com/aida-public/AB6AXuAvSz3U8fsP8nY4-AjtzgQMO3YaqaQf-VkUaFU5uvvvau-onB9wDpbNueMBYItFwYM8UsM2_VcCABiL9lJ70CbOqVHWe4PsTNL7k4cgLTywaX4grc-pGhckt6iDXi047alA1l8w_X8AJa69HU4RVb5QwhURMMzqlKuPZMds7zSmhqQws5S6n-Ty1P7Z5gQe9_uLNeMK_tInpqd_pou7a6yhJLawQ4IvaZt9XeWrOYOVezGwlueujlyHZH7YO1NYJv9ZeeFHVV_j_4vY"
  },
  signup: {
    stats: {
      scholars: "24k+",
