  ...
  return (
    <SafeAreaView style={[styles.safeArea, { backgroundColor: colors.background }]}>
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor={PROFILE_BRAND_BLUE} colors={[PROFILE_BRAND_BLUE]} />
        }
      >
        
        <View style={styles.hero}>
          <View style={styles.avatarWrap}>
            <View style={[styles.avatarRing, { borderColor: PROFILE_BRAND_BLUE + '35' }]}>
              <View style={[styles.avatar, { backgroundColor: colors.card }]}>
                {user?.profileImage ? (
                  <Image source={{ uri: user.profileImage }} style={styles.avatarImage} />
                ) : (
                  <IconSymbol name="person.fill" size={42} color={PROFILE_BRAND_BLUE} />
                )}
              </View>
            </View>
            <TouchableOpacity 
              style={[styles.avatarCamera, { backgroundColor: PROFILE_BRAND_BLUE }]}
          ...
          <View style={styles.memberRow}>
            <IconSymbol name="checkmark.circle.fill" size={14} color={PROFILE_BRAND_BLUE} />
            <Text style={[styles.memberText, { color: colors.text + '80' }]}>{membershipLabel}</Text>
          </View>

          <TouchableOpacity
            style={[styles.primaryBtn, { backgroundColor: PROFILE_BRAND_BLUE }]}
        ...
        <View style={[styles.groupCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
          <TouchableOpacity style={styles.row} onPress={() => setShowAccountModal(true)}>
            <View style={[styles.rowIcon, { backgroundColor: PROFILE_BRAND_BLUE + '12' }]}>
              <IconSymbol name="person.fill" size={18} color={PROFILE_BRAND_BLUE} />
            </View>
          ...
          <TouchableOpacity style={styles.row} onPress={() => setShowSecurityModal(true)}>
            <View style={[styles.rowIcon, { backgroundColor: PROFILE_BRAND_BLUE + '12' }]}>
              <IconSymbol name="hand.raised.fill" size={18} color={PROFILE_BRAND_BLUE} />
            </View>
            <View style={styles.rowText}>
              <Text style={[styles.rowTitle, { color: colors.text }]}>
        ...
        <View style={[styles.groupCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
          <View style={styles.row}>
            <View style={[styles.rowIcon, { backgroundColor: PROFILE_BRAND_BLUE + '12' }]}>
              <IconSymbol name={isDarkMode ? 'moon.fill' : 'sun.max.fill'} size={18} color={PROFILE_BRAND_BLUE} />
            </View>
            <View style={styles.rowText}>
              <Text style={[styles.rowTitle, { color: colors.text }]}>
          ...
          <View style={styles.row}>
            <View style={[styles.rowIcon, { backgroundColor: PROFILE_BRAND_BLUE + '12' }]}>
              <IconSymbol name="globe" size={18} color={PROFILE_BRAND_BLUE} />
            </View>
            <View style={styles.rowText}>
              <Text style={[styles.rowTitle, { color: colors.text }]}>
        ...
        <View style={[styles.groupCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
          <TouchableOpacity style={styles.row} onPress={() => setShowAboutModal(true)}>
            <View style={[styles.rowIcon, { backgroundColor: PROFILE_BRAND_BLUE + '12' }]}>
              <IconSymbol name="info.circle.fill" size={18} color={PROFILE_BRAND_BLUE} />
            </View>
            <View style={styles.rowText}>
          ...
          >
            <View style={[styles.rowIcon, { backgroundColor: PROFILE_BRAND_BLUE + '12' }]}>
              <IconSymbol name="house.fill" size={18} color={PROFILE_BRAND_BLUE} />
            </View>
            <View style={styles.rowText}>
