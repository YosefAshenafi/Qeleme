...
import type { Flashcard } from '@/shared/services/flashcardService';
        ...
        <View style={styles.cardStage}>
          <TouchableOpacity onPress={handleReveal} activeOpacity={0.95} style={styles.cardTouch}>
            <View style={styles.cardShadowWrap}>
              <Animated.View style={[styles.cardFace, frontAnimatedStyle as any, { backgroundColor: isDarkMode ? colors.cardAlt : '#FFFFFF' }]}>
                {!isDarkMode && (
                  <LinearGradient
              ...
              <Animated.View style={[styles.cardFace, styles.cardBack, backAnimatedStyle as any, { backgroundColor: isDarkMode ? colors.cardAlt : '#FFFFFF' }]}>
                {!isDarkMode && (
                  <LinearGradient
                    colors={['rgba(15,75,215,0.10)', 'rgba(15,75,215,0.00)']}
                    start={{ x: 1, y: 0 }}
